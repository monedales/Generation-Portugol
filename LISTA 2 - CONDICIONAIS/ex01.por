...
{
/*
 João comprou um microcomputador para controlar o rendimento diário de seu trabalho. Toda vez 
 ...
 */
	...
	funcao inicio()
	{
		...
		escreva("Insira a quantidade de tomates em Kg: ")
		leia(P)
		...
		escreva("\nO excesso de peso é: ", E, " e corresponde a multa de R$: ", M)		
	}
}
/* $$$ Portugol Studio $$$ 
 * 
